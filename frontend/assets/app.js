...
(function(){
  const plans={
    creator:{name:'创作者会员',category:'订阅会员',price:'¥29',cycle:'1 个月',discount:'首月低门槛体验',desc:'适合个人创作者和副业用户，低成本持续试片、做模板和生成基础投放素材。',benefits:[['会员权益','高清导出、去水印、基础商用授权'],['月度积分','每月赠送 500 积分'],['创作能力','剧本框架 技能、角色资产库、标准分镜、基础投放包'],['到账位置','个人中心 / 当前套餐、钱包、订单、商用授权同步更新']]},
    pro:{name:'专业会员',category:'订阅会员',price:'¥99',cycle:'1 个月',discount:'含 2,000 积分',desc:'适合日更、系列化、批量生成和内容团队冷启动，包含高级 技能 和投放复盘。',benefits:[['会员权益','高清导出、去水印、基础商用授权'],['月度积分','每月赠送 2,000 积分'],['创作能力','剧本扩写、细拆分镜、批量生成、投放素材矩阵'],['到账位置','个人中心 / 当前套餐、钱包、订单、商用授权同步更新']]},
    ...
    credits:{name:'标准积分充值包',category:'积分充值包',price:'¥49',cycle:'长期有效',discount:'600 积分',desc:'适合在会员额度之外按需扩展生成，用于标准视频、投放素材、批量重试和局部重绘。',benefits:[['积分到账','购买 600 积分，立即到账'],['使用范围','视频镜头、封面标题、投放素材、批量生成和局部重绘'],['补偿规则','生成失败自动补偿或退回积分'],['到账位置','个人中心 / 我的钱包、消耗记录和订单发票同步更新']]},
    ...
    series10:{name:'10集连载包',category:'项目包',price:'¥999 起',cycle:'按项目交付',discount:'含资产库和分镜',desc:'适合测试题材，包含资产库、分镜、视频和基础投放包。',benefits:[['交付范围','10 集连载规划、角色资产、标准分镜'],['投放素材','基础标题封面 钩子 和 多版本测试 记录'],['协作能力','项目阶段、团队协作和进度管理'],['到账位置','个人中心 / 我的项目、订单发票和商用授权同步更新']]},
    launchpack:{name:'投放素材包',category:'项目包 / 投放包',price:'¥399 起',cycle:'按素材交付',discount:'含 多版本测试 素材矩阵',desc:'围绕已有正片生成 5 封面、10 标题、3 钩子、多版本测试 矩阵和复盘建议。',benefits:[['交付范围','10 标题、5 封面、3 条 3 秒 钩子'],['测试矩阵','多版本测试 素材组合和推荐理由'],['复盘能力','点击率、完播率、转化收益记录表'],['到账位置','个人中心 / 我的项目、投放包和商用授权同步更新']]},
    project:{name:'项目包 / 投放包',category:'项目包',price:'¥999 起',cycle:'按项目交付',discount:'含交付范围确认',desc:'适合内容机构、工作室、版权方和品牌方，按集数、素材数量和交付范围打包。',benefits:[['交付范围','试制包、连载包、投放包和品牌剧情包'],['协作能力','团队权限、项目空间、成本测算和进度管理'],['商业保障','合同、发票、商用授权书和合规材料包'],['到账位置','个人中心 / 我的项目、订单发票和商用授权同步更新']]},
  ...
  if(successTitle){
    ...
    if(b1) b1.textContent=current==='credits'?'积分余额已更新，可立即用于视频生成、封面标题和投放素材。':current==='project'?'项目包权益已写入项目空间，可开始确认交付范围、生成投放包和下载授权记录。':current==='enterprise'?'企业合作需求已生成记录，可进入个人中心查看跟进状态。':'会员权益和每月积分已更新，可继续生成第一集和投放素材。';
